...
export default function TopTrailer({ mediaType }: TopTrailerProps) {
  ...
  useEffect(() => {
    if (data && data.results) {
      // Only consider titles that have an IMDb id, since that's what lets
      // us fetch a poster/backdrop from OMDb further down the tree.
      const videos = data.results.filter((item) => !!item.imdb_id);
              ...
              >
                ...
                <Stack
                  ...
                  sx={{
                    ...
                    // Safari needs the vendor-prefixed property too, or the
                    // blur silently does nothing on iOS/older WebKit.
