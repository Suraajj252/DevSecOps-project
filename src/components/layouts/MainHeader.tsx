  ...
  return (
    <AppBar
      sx={{
        ...
        ...(isOffset
          ? {
              // Was a flat bgcolor: "primary.main" - now a frosted glass
              // bar so content scrolling underneath stays faintly visible,
              // matching the rest of the v2.0 glassmorphism pass.
              ...
              borderBottom: (theme) => theme.palette.glass.border,
